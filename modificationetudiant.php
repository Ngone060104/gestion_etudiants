                ...
                <div class="P3">
                    ...
                    <div class="Gcontainer">
                        ...
                        <div class="card-form">
                            ...
                            <form class="grid-form" action="index.php?page=modifieretudiant&id=<?= $etudiantmod['id'] ?>"method="post">
                                <div class="form-group">
                                    <label for="nom">Nom</label>
                                    <input type="text" id="nom" name="nom" placeholder="Nom" value="<?=$etudiantmod["nom"] ??""?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="prenom" name="prenom" placeholder="prenom" value="<?=$etudiantmod["prenom"] ??""?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" id="tel" name="telephone" placeholder="tel" value="<?=$etudiantmod["telephone"] ??""?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email" name="email" placeholder="mail" value="<?=$etudiantmod["email"] ??""?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="adresse" name="adresse" placeholder="adresse" value="<?=$etudiantmod["adresse"] ??""?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="classe" name="classe">
                                        ...
                                        <?php foreach ($classes as $classe): ?>
                                            <option value="<?= $classe['id'] ?>" <?= $classe['id'] == $etudiantmod['classe'] ? 'selected' : '' ?>>
                                                <?= ($classe['libelle']) ?>
                                            </option>
                                ...
                                <div class="form-group full-width">
                                    <button type="submit" name="modifieretudiant">Modifier Étudiant</button>
                                </div>
